...
public:
    ...
    virtual bool
    Intersects(const Line& other, Point& intersection, Point& normal) const = 0;
    ...
    virtual bool
    Intersects(const Ray& other, Point& intersection, Point& normal) const;
    ...
    virtual bool
    Intersects(const Segment& other, Point& intersection, Point& normal) const;
