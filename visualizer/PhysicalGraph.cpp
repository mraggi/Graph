...
PhysicalGraph::PhysicalGraph(const Graph& g)
    : G(g), E(g.edges()), M(g.num_vertices())
{}

PhysicalGraph::PhysicalGraph(Vertex num_verts)
    : G(num_verts), E(num_verts), M(num_verts)
{}
