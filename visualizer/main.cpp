...
int main()
{
    ...
    APP.GUI.AddAction(
      "Run Kruskal's Algorithm", sf::Keyboard::W, AnimateKruskal);
    ...
    APP.GUI.AddAction(
      "Reset Default Colors", sf::Keyboard::Numpad0, ResetDefaultColors);
...
PhysicalGraph PumGraph(const std::vector<Point>& P)
{
