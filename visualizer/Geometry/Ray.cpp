...
Ray::Ray(const Segment& segment) : Convex(segment.Origin()), m_rAngle(segment.Angle()) {}
...
bool Ray::Intersects(const Point& other) const { return CPoint(other).Intersects(*this); }

bool Ray::Intersects(const Line& other) const { return other.Intersects(*this); }
...
bool Ray::Intersects(const Circle& other) const { return other.Intersects(*this); }

bool Ray::Intersects(const Box& other) const { return other.Intersects(*this); }

bool Ray::Intersects(const Polygon& other) const { return other.Intersects(*this); }
...
bool Ray::Intersects(const Line& other, Point& intersection, Point& normal) const
{
