...
bool CPoint::Intersects(const Point& other) const
{
	return Position() == other;
}

bool CPoint::Intersects(const Line& other) const
{
	return other.Intersects(Position());
}

bool CPoint::Intersects(const Circle& other) const
{
	return other.Intersects(Position());
}

bool CPoint::Intersects(const Box& other) const
{
	return other.Intersects(Position());
}

bool CPoint::Intersects(const Polygon& other) const
{
	return other.Intersects(Position());
}
...
Point CPoint::ClosestPoint(const Point& point) const
{
	return Position();
}
