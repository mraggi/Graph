...
public:
    ...
    using neighbor_iterator = neighbor_list::const_iterator;
    ...
    all_vertices vertices() const { return all_vertices(m_numvertices); }
    ...
    neighbor_iterator get_neighbor(vertex_t from, vertex_t to) const;
